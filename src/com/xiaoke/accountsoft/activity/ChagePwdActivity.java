 ...
 * 修改登录密码
 */
public class ChagePwdActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnSet.setOnClickListener(new OnClickListener() {// 为设置按钮添加监听事件
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				PwdDAO pwdDAO = new PwdDAO(ChagePwdActivity.this);// 创建PwdDAO对象
				...
				// 弹出信息提示
				Toast.makeText(ChagePwdActivity.this, "〖密码〗设置成功！", Toast.LENGTH_SHORT)
				.show();
			}
		});
